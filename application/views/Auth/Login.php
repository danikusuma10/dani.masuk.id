            ...
            <div class="col-lg">
              <div class="p-4">
                <div class="text-center">
                  <img src="<?= base_url('assets/'); ?>logo/logoypt.png" alt="logo-image" class="img-circle">
                  <p class="font-weight-normal">YPT's SMART PAYMENT GATEWAY</p> METODE PAYMENT GATEWAY</p>
